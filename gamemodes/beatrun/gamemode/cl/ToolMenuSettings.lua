...
hook.Add("PopulateToolMenu", "Beatrun_ToolMenu", function()
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Client", "beatrun_hud", "#beatrun.toolsmenu.hud.name", "", "", function(panel)
		...
		keystrokecorner:AddChoice("0 - Top-left")
		keystrokecorner:AddChoice("1 - Top-right")
		keystrokecorner:AddChoice("2 - Bottom-left")
		keystrokecorner:AddChoice("3 - Bottom-right")
		...
		speedomode:AddChoice("0 - Kilometers per hour (km/h)")
		speedomode:AddChoice("1 - Miles per hour (mph)")
		speedomode:AddChoice("2 - Hammer Units per hour (hu/h)")
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Client", "beatrun_gameplay", "#beatrun.toolsmenu.gameplay.name", "", "", function(panel)
		...
		local animsetting = panel:ComboBox("Animation Set to Use", "Beatrun_AnimSet")
		animsetting:AddChoice("0 - Reanimated (by MTB)")
		animsetting:AddChoice("1 - Mirror's Edge - edited (by EA DICE, ported by datae)")
		animsetting:AddChoice("2 - UNSUPPORTED: Mirror's Edge (by EA DICE, ported by datae, UNMAINTAINED)")
