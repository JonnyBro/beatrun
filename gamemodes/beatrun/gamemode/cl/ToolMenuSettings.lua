...
hook.Add("PopulateToolMenu", "Beatrun_ToolMenu", function()
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Server", "beatrun_misc", "#beatrun.toolsmenu.misc.name", "", "", function(panel)
		...
		propSpawnToggle:SetChecked(GetConVar("Beatrun_AllowPropSpawn"):GetBool() or false)
		...
		weaponSpawnToggle:SetChecked(GetConVar("Beatrun_AllowWeaponSpawn"):GetBool() or false)
		...
		overdriveMpToggle:SetChecked(GetConVar("Beatrun_AllowOverdriveInMultiplayer"):GetBool() or false)
		...
		healthRegenToggle:SetChecked(GetConVar("Beatrun_HealthRegen"):GetBool() or true)
		...
		realisticClimbingToggle:SetChecked(GetConVar("Beatrun_LeRealisticClimbing"):GetBool() or true)
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Server", "beatrun_moves", "#beatrun.toolsmenu.moves.name", "", "", function(panel)
		...
		speedLimitSlider:SetValue(GetConVar("Beatrun_SpeedLimit"):GetInt() or 325)
		...
		forcePuristModeToggle:SetChecked(GetConVar("Beatrun_PuristModeForce"):GetBool() or false)
		...
		puristWallrunToggle:SetChecked(GetConVar("Beatrun_PuristWallrun"):GetBool() or true)
		...
		kickGlitchSelect:SetValue("#beatrun.toolsmenu.moves.kickglitch" .. GetConVar("Beatrun_Kickglitch"):GetInt() or 2)
		...
		quakeJumpToggle:SetChecked(GetConVar("Beatrun_QuakeJump"):GetBool() or true)
		...
		sideStepToggle:SetChecked(GetConVar("Beatrun_SideStep"):GetBool() or true)
		...
		disarmToggle:SetChecked(GetConVar("Beatrun_Disarm"):GetBool() or true)
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Server", "beatrun_gamemodes", "#beatrun.toolsmenu.gamemodes.name", "", "", function(panel)
		...
		infectionStartTimeSlider:SetValue(GetConVar("Beatrun_InfectionStartTime"):GetInt() or 10)
		...
		infectionGameTimeSlider:SetValue(GetConVar("Beatrun_InfectionGameTime"):GetInt() or 190)
