...
hook.Add("PopulateToolMenu", "Beatrun_ToolMenu", function()
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Client", "beatrun_hud", "#beatrun.toolsmenu.hud.name", "", "", function(panel)
		...
		local speedometermode = panel:ComboBox("#beatrun.toolsmenu.hud.speedometermode", "Beatrun_SpeedometerMode")
		speedometermode:AddChoice("#beatrun.toolsmenu.hud.speedometermode1", 1)
		speedometermode:AddChoice("#beatrun.toolsmenu.hud.speedometermode2", 2)
		speedometermode:AddChoice("#beatrun.toolsmenu.hud.speedometermode3", 3)
		speedometermode:SetSortItems(false)
	...
	spawnmenu.AddToolMenuOption("Beatrun", "Server", "beatrun_misc", "#beatrun.toolsmenu.misc.name", "", "", function(panel)
		...
		local enititesSpawnToggle = vgui.Create("DCheckBoxLabel")
		enititesSpawnToggle:SetText("#beatrun.toolsmenu.misc.weaponspawn")
		enititesSpawnToggle:SetDark(true)
		enititesSpawnToggle:SetChecked(GetConVar("Beatrun_AllowEntitiesSpawn"):GetBool())
		function enititesSpawnToggle:OnChange(value)
			ChangeConvar("Beatrun_AllowEntitiesSpawn", value and 1 or 0)
		end
		panel:AddItem(enititesSpawnToggle)
		panel:ControlHelp("#beatrun.toolsmenu.misc.weaponspawndesc")

		local disableOverdrive = vgui.Create("DCheckBoxLabel")
		disableOverdrive:SetText("#beatrun.toolsmenu.misc.disableoverdrive")
		disableOverdrive:SetDark(true)
		disableOverdrive:SetChecked(GetConVar("Beatrun_DisableOverdrive"):GetBool())
		function disableOverdrive:OnChange(value)
			ChangeConvar("Beatrun_DisableOverdrive", value and 1 or 0)
		end
		panel:AddItem(disableOverdrive)
		panel:ControlHelp("#beatrun.toolsmenu.misc.disableoverdrivedesc")
